...
- adds text after titles in articles, contacts, etc.

It demonstrates the functionality described in 
[Plugin Methods and Arguments](https://manual.joomla.org/docs/building-extensions/plugins/methods-and-arguments/).